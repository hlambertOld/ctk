...
public class RequestObject {
   ...
   * @param serverPort The destination server port
   */
  public RequestObject (DataObject dataObject, String messageUrl, String serverHostname, int serverPort, String serverId){
    this (dataObject, messageUrl, serverHostname, serverPort, serverId, null);
  }
   ...
   * @param serverPort The destination server port
   */
  public RequestObject (DataObject dataObject, String messageUrl, String serverHostname, int serverPort, String serverId, String type){
    if (dataObject != null)
