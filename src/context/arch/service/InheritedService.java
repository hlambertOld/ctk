...
public class InheritedService extends Service implements AsyncServiceHandler {
  ...
  public DataObject execute(ServiceInput serviceInput) {
    String timing = getFunctionDescriptions().getFunctionDescription(serviceInput.getFunctionName()).getTiming();
    if (timing.equals(SYNCHRONOUS)) {
    ...
    else if (timing.equals(ASYNCHRONOUS)) {
