 ...
 * @author  Agathe
 */
public class OutAttributeIndexTable extends AbstractStringToIntegerVectorIndexTable {

  /**
   * Creates new OutAttributeIndexTable 
   */
  public OutAttributeIndexTable (String indexName) {
    super(indexName);
  }
