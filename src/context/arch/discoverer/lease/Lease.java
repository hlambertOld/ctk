...
public class Lease {
   ...
   *
   * @param index The index of the component description owning the lease
   */
  public void setComponentIndex(Integer index){
    if (index != null) {
  ...
  public void setStartDate(Calendar date){
    ...
    System.out.println("Lease nbTimeSlots = " + this.nbTimeSlots);
    System.out.println("Lease - start date=" + start.getTime () + "\n - end=" + end.getTime ());
  }
  ...
  public static Lease dataObjectToLease(DataObject dataObject){
    ...
    if (dataObject != null) {
      ...
      if (leaseInfo != null) {
        ...
        if (doSlots != null){
          Vector v = doSlots.getValue ();
          if (v != null && ! v.isEmpty ()){
            String slots = (String) v.firstElement ();
            if (slots != null){
              try {
