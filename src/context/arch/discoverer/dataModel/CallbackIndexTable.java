 ...
 * @author  Agathe
 */
public class CallbackIndexTable extends AbstractStringToIntegerVectorIndexTable {

  /**
   * Creates new CallbackIndexTable 
   */
  public CallbackIndexTable (String indexName) {
    super(indexName);
  }
