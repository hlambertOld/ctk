  ...
  public Socket sendRequest(String content) throws IOException{
    ...
    try {
        ...
        if(remoteServer.equals("LT001")){
            remoteServer = "192.168.1.10";
        }
      s = new Socket(remoteServer, portNumber);
    }
    catch (IOException ioe){
        ioe.printStackTrace();
      System.out.println ("HTTPClientSocket <sendRequest> While creating socket in sendRequest: " + ioe);
      throw ioe;
    }
    catch (Exception e) {
      System.out.println ("HTTPClientSocket <sendRequest> While creating socket in sendRequest: " + e);
    }
