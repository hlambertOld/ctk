/*
 * CstAttributeNameIndexTable.java
 *
 ...
 * @author  Agathe
 */
public class CstAttributeNameIndexTable extends AbstractStringToIntegerVectorIndexTable {

  /**
   * Creates new CstAttributeNameIndexTable 
   */
  public CstAttributeNameIndexTable(String indexName) {
    super(indexName);
  }
  ...
  public Object getElementAsIndex(Object componentDescription){
    return ((ComponentDescription)componentDescription).getConstantAttributeNames();
  }
